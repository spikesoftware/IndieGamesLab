...
namespace IGL.Common.Tests
{
    ...
    {        
        ...
        {
            var list1 = new Dummy { MyIntList = new System.Collections.Generic.List<int> { 1, 2, 3 }, MyProperty = 1, MyStringList = new System.Collections.Generic.List<string> { "1", "2", "3" } };
