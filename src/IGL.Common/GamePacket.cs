...
namespace IGL
{
    [DataContract(Namespace = "uri:igl:v2")]
    public class GamePacket
    {
        public const string VERSION = "IGL.V2.Version";
            ...
            get
            {
                if (_namespace == null)
                    try
                    {
                        ...
                        var attribute = typeof(GamePacket).GetCustomAttributes(typeof(DataContractAttribute), false)
                            .FirstOrDefault();
                    ...
                    {
                        Trace.TraceError(
                            "IGL.GamePacket Failed to determine the namespace.  Setting the namespace to v0 so this can be investigated server side. Note:" +
                            ex.GetFullMessage());
        ...
        public static string EncryptStringAES(string plainText)
        {
            ...
            try
            {
                ...
                var key = new Rfc2898DeriveBytes(Namespace, SALT);
